        ...
        <div class="modal-body popups">
                    <div style="padding-top:10px" class="panel-body" >
                        ...
                        <br>
                           ...
                           <center> <a class='attachonnotice' id="attachpath" style="text-decoration: none" href="" target="_blank"><button class="btn btn-block btn-primary"><img  src='img/unnamed.png' width='30px' height='30px'  alt=''/>&nbsp;&nbsp;<strong>Download Attachment(PDF)</strong></button></a></center>
    </div>
  </div>
</div>
